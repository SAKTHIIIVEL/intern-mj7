...
useEffect(() => {
  ...
  return (
    <section id="contact" className="w-full bg-black py-24 px-6 max-[1439px]:px-[120px] max-sm:px-[20px] max-sm:py-[70px] min-[1440px]:px-[152px]">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 max-md:gap-[10px]">
        {/* LEFT CONTENT */}
        <div
  ref={leftRef}
  className={`
...
>
          ...
          <h2 className="text-[100px] font-[900] leading-none mb-6 max-sm:text-[48px]">
            <span className="text-red-600">CONTACT</span>
            <br />
            <span className="text-white flex items-center gap-4">
              US <span className="max-sm:hidden w-[260px] h-[5px] bg-white inline-block" />
...
{/* mobile links */}
<div className="flex gap-8 mt-[30px] lg:hidden">
            <div
              className="w-18 h-18 rounded-full
             bg-[#111]
             flex items-center justify-center
