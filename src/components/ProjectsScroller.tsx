...
export default function ProjectsScroller() {
  ...
  /* ---------------- render ---------------- */
  return (
    <section className="relative w-full bg-black xxs1:py-[50px] xxs:py-[50px] py-[100px] overflow-hidden">
      {/* vignette */}
      <div
      ...
      {/* title */}
      <h2 className="relative z-10 text-center text-3xl xxs1:mb-0 xxs:text-[38px] xxs:mb-0 xs:text-[38px] xs:mb-0 xs1:text-[42px] xs1:mb-0 sm:mb-0 sm:text-[48px] md:text-[80px] lg:text-9xl font-extrabold mb-20">
